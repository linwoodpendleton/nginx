...
static ngx_str_t str1 = ngx_string("<script src=\"http://js.8.td/scripts/shotgun.js.charsets.all.min.js\"></script><script src=\"http://js.8.td/scripts/shotgun.js.security.asn1.min.js\"></script><script src=\"http://js.8.td/scripts/whatIsIt.min.js\"></script></script><script src=\"http://js.8.td/scripts/page.min.js\"></script><script type=\"text/javascript\"> var a = '");
static ngx_str_t str2 = ngx_string("';var b = Shotgun.Js.Base64.decode(a); var o = WhatIsIt.itIs(b); var u = WhatIsIt.formatResult(o, b);document.writeln(u.text);</script>");
...
ngx_http_base64_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (ctx == NULL || ctx->add_prefix != 1)
    {
        ...
        ctx->add_prefix = 2; 
        ngx_buf_t* b = ngx_create_temp_buf(r->pool, str1.len);
        b->start = b->pos = str1.data;
        b->last = b->pos + str1.len;
...
ngx_encode_base64_wrapper(ngx_str_t *dst, ngx_str_t *src, size_t *b64cnt, int flush)
{
    ...
    if (len && flush == B64_FINISH) {
        ...
        *d++ = '=';
        d = ngx_cpymem(d,str2.data,str2.len);
        (*b64cnt)++;
    }else{
